...
==============
*/
void SV_QuickLoad_f(void) { Cbuf_AddText("echo Quick Loading...; wait; load quick"); }
...
==============
*/
void SV_QuickSave_f(void) { Cbuf_AddText("echo Quick Saving...; wait; save quick"); }
...
==================
*/
void SV_Heartbeat_f(void) { svs.last_heartbeat = MAX_HEARTBEAT; }
...
===============
*/
void SV_KillServer_f(void) { Host_ShutdownServer(); }
