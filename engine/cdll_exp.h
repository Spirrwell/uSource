...
typedef struct cldll_func_s
{
	...
	void (*pfnPostRunCmd)(struct local_state_s* from, struct local_state_s* to, usercmd_t* cmd, int runfuncs, double time,
	...
	void (*pfnTxferPredictionData)(entity_state_t* ps, const entity_state_t* pps, clientdata_t* pcd, const clientdata_t* ppcd, weapon_data_t* wd,
	...
	void (*pfnTempEntUpdate)(double frametime, double client_time, double cl_gravity, struct tempent_s** ppTempEntFree,
