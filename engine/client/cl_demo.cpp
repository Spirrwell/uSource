...
const char* demo_cmd[dem_lastcmd + 1] = {
	"dem_unknown", "dem_norewind", "dem_read", "dem_jumptime", "dem_userdata", "dem_usercmd", "dem_stop",
};
...
====================
*/
float CL_GetDemoRecordClock(void) { return cl.mtime[0]; }
...
====================
*/
float CL_GetDemoPlaybackClock(void) { return host.realtime + host.frametime; }
...
void CL_DrawDemoRecording(void)
{
	...
	Q_snprintf(string, sizeof(string), "^1RECORDING:^7 %s: %s time: %02d:%02d", cls.demoname, Q_memprint(pos), (int)(cls.demotime / 60.0f),
