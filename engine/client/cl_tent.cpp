...
const char* cl_default_sprites[] = {
	// built-in sprites
	"sprites/muzzleflash1.spr", "sprites/muzzleflash2.spr", "sprites/muzzleflash3.spr", "sprites/dot.spr",
	"sprites/animglow01.spr",   "sprites/richo1.spr",	"sprites/shellchrome.spr",
};
...
==============
*/
TEMPENTITY* CL_TempEntAllocNoModel(const vec3_t org) { return CL_TempEntAlloc(org, NULL); }
...
================
*/
void CL_ClearLightStyles(void) { memset(cl.lightstyles, 0, sizeof(cl.lightstyles)); }
