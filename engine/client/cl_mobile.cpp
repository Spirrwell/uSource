...
static mobile_engfuncs_t gpMobileEngfuncs = {MOBILITY_API_VERSION,
					     pfnVibrate,
					     pfnEnableTextInput,
...
qboolean Mobile_Init(void)
{
	...
	ExportToClient	= reinterpret_cast<pfnMobilityInterface>(COM_GetProcAddress(clgame.hInstance, MOBILITY_CLIENT_EXPORT));
...
void Mobile_Shutdown(void) { Cmd_RemoveCommand("vibrate"); }
