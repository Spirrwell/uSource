...
void UI_ConnectionProgress_Download(const char* pszFileName, const char* pszServerName, const char* pszServerPath, int iCurrent, int iTotal,
				    const char* comment)
{
...
static int UI_GetLogoWidth(void) { return gameui.logo_xres; }

static int UI_GetLogoHeight(void) { return gameui.logo_yres; }

static float UI_GetLogoLength(void) { return gameui.logo_length; }
...
====================
*/
static cl_entity_t* pfnGetPlayerModel(void) { return &gameui.playermodel; }
...
====================
*/
static void pfnClientJoin(const netadr_t adr) { Cbuf_AddText(va("connect %s\n", NET_AdrToString(adr))); }
...
====================
*/
static int pfnKeyGetOverstrikeMode(void) { return host.key_overstrike; }
...
====================
*/
static void pfnKeySetOverstrikeMode(int fActive) { host.key_overstrike = fActive; }
...
=========
*/
static void* pfnMemAlloc(size_t cb, const char* filename, const int fileline) { return _Mem_Alloc(gameui.mempool, cb, true, filename, fileline); }
...
=========
*/
static void pfnMemFree(void* mem, const char* filename, const int fileline) { _Mem_Free(mem, filename, fileline); }
...
=========
*/
static char* pfnGetClipboardData(void) { return Sys_GetClipboardData(); }
...
=========
*/
static void pfnStartBackgroundTrack(const char* introTrack, const char* mainTrack) { S_StartBackgroundTrack(introTrack, mainTrack, 0, false); }
...
// engine callbacks
static ui_enginefuncs_t gEngfuncs = {pfnPIC_Load,
				     GL_FreeImage,
				     pfnPIC_Width,
				     pfnPIC_Height,
				     pfnPIC_Set,
...
static void pfnEnableTextInput(int enable) { Key_EnableTextInput(enable, false); }
...
static ui_extendedfuncs_t gExtendedfuncs = {pfnEnableTextInput, Con_UtfProcessChar, Con_UtfMoveLeft, Con_UtfMoveRight, pfnGetRenderers};
