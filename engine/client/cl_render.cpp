...
const ref_overview_t* GL_GetOverviewParms(void) { return &clgame.overView; }

static void* R_Mem_Alloc(size_t cb, const char* filename, const int fileline) { return _Mem_Alloc(cls.mempool, cb, true, filename, fileline); }
...
static int pfnRenderGetParm(int parm, int arg) { return CL_RenderGetParm(parm, arg, true); }
