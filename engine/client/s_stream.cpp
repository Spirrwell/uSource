...
=================
*/
void S_FadeMusicVolume(float fadePercent) { musicfade.percent = bound(0.0f, fadePercent, 100.0f); }
...
=================
*/
void S_StreamSetPause(int pause) { s_listener.stream_paused = pause; }
