...
void R_DrawLeafNode(float x, float y, float scale)
{
	...
	ref.dllFuncs.R_DrawStretchPic(x - downScale * 0.5f, y - downScale * 0.5f, downScale, downScale, 0, 0, 1, 1,
