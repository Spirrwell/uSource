...
===============
*/
void CL_SetLastUpdate(void) { cls.lastupdate_sequence = cls.netchan.incoming_sequence; }
...
static int pfnTestPlayerPosition(float* pos, pmtrace_t* ptrace) { return PM_TestPlayerPosition(clgame.pmove, pos, ptrace, NULL); }
...
static int pfnTruePointContents(float* p) { return PM_TruePointContents(clgame.pmove, p); }
