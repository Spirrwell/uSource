...
================
*/
double GAME_EXPORT Sys_DoubleTime(void) { return Platform_DoubleTime(); }
...
================
*/
void Sys_SetClipboardData(const char* buffer, size_t size) { Platform_SetClipboardText(buffer, size); }
...
#ifdef XASH_SDL
		if (host.hWnd)
			SDL_HideWindow((SDL_Window*)host.hWnd);
#endif
	}
