...
static mlumpinfo_t srclumps[HEADER_LUMPS] = {
	...
	{LUMP_NODES, 1, MAX_MAP_NODES, sizeof(dnode_t), sizeof(dnode32_t), "nodes", CHECK_OVERFLOW, (const void**)&srcmodel.nodes,
	 &srcmodel.numnodes},
	...
	{LUMP_FACES, 0, MAX_MAP_FACES, sizeof(dface_t), sizeof(dface32_t), "faces", CHECK_OVERFLOW, (const void**)&srcmodel.surfaces,
	...
	{LUMP_CLIPNODES, 0, MAX_MAP_CLIPNODES, sizeof(dclipnode_t), sizeof(dclipnode32_t), "clipnodes", 0, (const void**)&srcmodel.clipnodes,
	 reinterpret_cast<size_t*>(&srcmodel.numclipnodes)},
	{LUMP_LEAFS, 1, MAX_MAP_LEAFS, sizeof(dleaf_t), sizeof(dleaf32_t), "leafs", CHECK_OVERFLOW, (const void**)&srcmodel.leafs,
	 reinterpret_cast<size_t*>(&srcmodel.numleafs)},
	{LUMP_MARKSURFACES, 0, MAX_MAP_MARKSURFACES, sizeof(dmarkface_t), sizeof(dmarkface32_t), "markfaces", 0, (const void**)&srcmodel.markfaces,
...
static mlumpinfo_t extlumps[EXTRA_LUMPS] = {
	{LUMP_LIGHTVECS, 0, MAX_MAP_LIGHTING, sizeof(byte), -1, "deluxmaps", USE_EXTRAHEADER, (const void**)&srcmodel.deluxdata,
	 &srcmodel.deluxdatasize},
	{LUMP_FACEINFO, 0, MAX_MAP_FACEINFO, sizeof(dfaceinfo_t), -1, "faceinfos", CHECK_OVERFLOW | USE_EXTRAHEADER, (const void**)&srcmodel.faceinfo,
	 &srcmodel.numfaceinfo},
	{LUMP_SHADOWMAP, 0, MAX_MAP_LIGHTING / 3, sizeof(byte), -1, "shadowmap", USE_EXTRAHEADER, (const void**)&srcmodel.shadowdata,
