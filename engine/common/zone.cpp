...
void _Mem_Free(void* data, const char* filename, int fileline) { g_pZoneAllocator->_Mem_Free(data, filename, fileline); }
...
byte* _Mem_AllocPool(const char* name, const char* filename, int fileline) { return g_pZoneAllocator->_Mem_AllocPool(name, filename, fileline); }

void _Mem_FreePool(byte** poolptr, const char* filename, int fileline) { g_pZoneAllocator->_Mem_FreePool(poolptr, filename, fileline); }

void _Mem_EmptyPool(byte* poolptr, const char* filename, int fileline) { g_pZoneAllocator->_Mem_EmptyPool(poolptr, filename, fileline); }
...
========================
*/
qboolean Mem_IsAllocatedExt(byte* poolptr, void* data) { return g_pZoneAllocator->Mem_IsAllocatedExt(poolptr, data); }

void _Mem_Check(const char* filename, int fileline) { return g_pZoneAllocator->_Mem_Check(filename, fileline); }

void Mem_PrintStats(void) { return g_pZoneAllocator->Mem_PrintStats(); }

void Mem_PrintList(size_t minallocationsize) { return g_pZoneAllocator->Mem_PrintList(minallocationsize); }
...
========================
*/
void Memory_Init(void) { g_pZoneAllocator->Memory_Init(); }
