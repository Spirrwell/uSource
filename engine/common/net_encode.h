...
// helper macroses
#define ENTS_DEF( x )	#x, (int)(unsigned long)offsetof( entity_state_t, x ), sizeof( ((entity_state_t *)0)->x )
#define UCMD_DEF( x )	#x, (int)(unsigned long)offsetof( usercmd_t, x ), sizeof( ((usercmd_t *)0)->x )
#define EVNT_DEF( x )	#x, (int)(unsigned long)offsetof( event_args_t, x ), sizeof( ((event_args_t *)0)->x )
#define PHYS_DEF( x )	#x, (int)(unsigned long)offsetof( movevars_t, x ), sizeof( ((movevars_t *)0)->x )
#define CLDT_DEF( x )	#x, (int)(unsigned long)offsetof( clientdata_t, x ), sizeof( ((clientdata_t *)0)->x )
#define WPDT_DEF( x )	#x, (int)(unsigned long)offsetof( weapon_data_t, x ), sizeof( ((weapon_data_t *)0)->x )
