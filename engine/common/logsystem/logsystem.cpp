...
static unsigned char* g_color_map[] = {
	g_color_white, g_color_black, g_color_yellow, g_color_red, g_color_blue, g_color_green,
};
 ...
 */
bool CLoggingSystem::SupportsRemoteLogging() { return false; }

void CLoggingSystem::ConnectPort(int port) { /* Stub for now */ }

void CLoggingSystem::DisconnectPort(int port) { /* Stub for now */ }
...
void CLoggingSystem::SetColor(const char colo[3]) { ::SetColor(this->_stdout, colo[0], colo[1], colo[2]); }

void CLoggingSystem::ClearColor() { ::SetColor(this->_stdout, default_color[0], default_color[1], default_color[2]); }
...
const char* CLoggingSystem::GetParentInterface() { return ILOGSYSTEM_INTERFACE; }

const char* CLoggingSystem::GetName() { return CLOGGINGSYSTEM_NAME; }
...
void CLoggingSystem::SetStdin(FILE* stream) { this->_stdin = stream; }

void CLoggingSystem::SetStdout(FILE* stream) { this->_stdout = stream; }

void CLoggingSystem::AddStdin(FILE* stream) { this->m_stdin.push_back(stream); }

void CLoggingSystem::AddStdout(FILE* stream) { this->m_stdout.push_back(stream); }

void CLoggingSystem::RemoveStdin(FILE* stream) { this->m_stdin.remove(stream); }

void CLoggingSystem::RemoveStdout(FILE* stream) { this->m_stdout.remove(stream); }
