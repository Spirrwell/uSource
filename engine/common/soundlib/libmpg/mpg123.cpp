...
mpg123_handle_t* mpg123_new(int* error) { return mpg123_parnew(NULL, error); }
...
int mpg123_read(mpg123_handle_t* mh, byte* out, size_t size, size_t* done) { return mpg123_decode(mh, NULL, 0, out, size, done); }
