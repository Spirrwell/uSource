...
============
*/
base_command_hashmap_t* BaseCmd_GetBucket(const char* name) { return hashed_cmds[COM_HashKey(name, HASH_SIZE)]; }
...
============
*/
void BaseCmd_Init(void) { memset(hashed_cmds, 0, sizeof(hashed_cmds)); }
