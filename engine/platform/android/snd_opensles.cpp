...
static SLresult SLAPIENTRY (*pslCreateEngine)(SLObjectItf* pEngine, SLuint32 numOptions, const SLEngineOption* pEngineOptions, SLuint32 numInterfaces,
...
int SNDDMA_GetDMAPos(void) { return snddma_android_pos; }
...
void SNDDMA_Submit(void) { pthread_mutex_unlock(&snddma_android_mutex); }
