...
{
public:
	CColor() : rgba(0), init(false), a(3, rgba), r(2, rgba), g(1, rgba), b(0, rgba) {}
	CColor(unsigned int rgba_) : rgba(rgba_), init(false), a(3, rgba), r(2, rgba), g(1, rgba), b(0, rgba) {}
...
private:
	...
	public:
		...
		inline operator unsigned int() const { return (_rgba >> _byte * 8) & 0xff; }
		friend class CColor;
	};
	bool init;
