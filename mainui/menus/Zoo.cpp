...
public:
	...
	static void OKButtonCommand(CMenuBaseItem* pSelf, void* pExtra) { pSelf->Parent()->Hide(); }

	static void CancelButtonCommand(CMenuBaseItem* pSelf, void* pExtra) { pSelf->Parent()->Hide(); }
...
void CMenuZoo::_Init()
{
	...
	*/
	...
	const char* pics[] = {"gfx/shell/head_advanced.tga",	  "gfx/shell/head_advoptions.tga", "gfx/shell/head_audio.tga",
