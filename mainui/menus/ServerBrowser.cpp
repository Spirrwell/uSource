...
struct server_t
{
	...
	static int NameCmpDescend(const void* a, const void* b) { return NameCmpAscend(b, a); }
	...
	static int MapCmpDescend(const void* a, const void* b) { return MapCmpAscend(b, a); }
	...
	static int ClientCmpDescend(const void* a, const void* b) { return ClientCmpAscend(b, a); }
	...
	static int PingCmpDescend(const void* a, const void* b) { return PingCmpAscend(b, a); }
};
...
public:
	...
	int	  GetRows() const override { return servers.Count(); }
	...
	bool IsHavePassword(int line) { return servers[line].havePassword; }
...
public:
	...
	void JoinGame(void);
	void ResetPing(void) { gameListModel.serversRefreshTime = Sys_DoubleTime(); }
...
bool CMenuGameListModel::Sort(int column, bool ascend)
{
	...
	case 0:
		return false;
	case 1:
		qsort(servers.Base(), servers.Count(), sizeof(server_t), ascend ? server_t::NameCmpAscend : server_t::NameCmpDescend);
		return true;
	case 2:
		qsort(servers.Base(), servers.Count(), sizeof(server_t), ascend ? server_t::MapCmpAscend : server_t::MapCmpDescend);
		return true;
	case 3:
		qsort(servers.Base(), servers.Count(), sizeof(server_t), ascend ? server_t::ClientCmpAscend : server_t::ClientCmpDescend);
		return true;
	case 4:
		qsort(servers.Base(), servers.Count(), sizeof(server_t), ascend ? server_t::PingCmpAscend : server_t::PingCmpDescend);
		return true;
	}
...
void CMenuGameListModel::OnActivateEntry(int line) { CMenuServerBrowser::Connect(servers[line]); }
...
=================
*/
void CMenuServerBrowser::JoinGame() { gameListModel.OnActivateEntry(gameList.GetCurrentIndex()); }
