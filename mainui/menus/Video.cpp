...
=================
*/
void UI_Video_Precache(void) { EngFuncs::PIC_Load(ART_BANNER); }
...
void UI_Video_Menu(void)
{
	...
	if (!video.WasInit())
	{
		...
		video.AddButton(L("Video options"), L("Set video options such as screen size, gamma and image quality."), PC_VID_OPT,
				UI_VidOptions_Menu, QMF_NOTIFY);
