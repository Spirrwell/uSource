...
void CMenuMain::_VidInit() { VidInit(CL_IsActive()); }
...
CONCOMMAND(ResumeGame, "Resumes the game", 0) { UI_CloseMenu(); }

CONCOMMAND(Disconnect, "Disconnects from the server", 0) { uiMain.DisconnectDialogCb(); }

CONCOMMAND(OpenNewGameDialog, "Opens the new game dialog", 0) { UI_NewGame_Menu(); }

CONCOMMAND(OpenLoadGameDialog, "Opens the load game dialog", 0) { UI_LoadGame_Menu(); }

CONCOMMAND(OpenSaveGameDialog, "Opens the save game dialog", 0) {}

CONCOMMAND(OpenServerBrowser, "Opens the server browser", 0) { UI_MultiPlayer_Menu(); }

CONCOMMAND(OpenCreateMultiplayerGameDialog, "Opens the multiplayer game dialog", 0) { UI_CustomGame_Menu(); }

CONCOMMAND(OpenChangeGameDialog, "", 0) {}

CONCOMMAND(OpenOptionsDialog, "", 0) { UI_Options_Menu(); }

CONCOMMAND(QuitGame, "", 0) { uiMain.QuitDialog(); }
...
CONCOMMAND(StartHazardCourse, "", 0) { uiMain.HazardCourseCb(); }
...
=================
*/
void UI_Main_Menu(void) { uiMain.Show(); }
