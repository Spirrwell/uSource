...
void CMenuInputDevices::_Init(void)
{
	...
	SET_EVENT_MULTI(mouse.onChanged, {
		if (((CMenuCheckBox*)pSelf)->bChecked)
		{
			...
			SET_EVENT_MULTI(msgbox.onNegative, { uiInputDevices.mouse.bChecked = false; });
...
void CMenuInputDevices::_VidInit() { GetConfig(); }
...
=================
*/
void UI_InputDevices_Menu(void) { uiInputDevices.Show(); }
