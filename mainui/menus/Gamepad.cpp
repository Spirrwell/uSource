...
static const char* axisNames[7] = {"Side Movement", "Forward Movement", "Camera Vertical Turn", "Camera Horizontal Turn", "Right Trigger",
				   "Left Trigger",  "NOT BOUND"};
...
=================
*/
void UI_GamePad_Precache(void) { EngFuncs::PIC_Load(ART_BANNER); }
...
=================
*/
void UI_GamePad_Menu(void) { uiGamePad.Show(); }
