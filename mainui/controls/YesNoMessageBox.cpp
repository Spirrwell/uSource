...
==============
*/
void CMenuYesNoMessageBox::SetMessage(const char* msg) { dlgMessage1.szName = (msg); }
...
CEventCallback CMenuYesNoMessageBox::MakeOpenEvent() { return CEventCallback(OpenCb, this); }
...
==============
*/
void CMenuYesNoMessageBox::OpenCb(CMenuBaseItem*, void* pExtra) { ToggleInactiveInternalCb((CMenuBaseItem*)pExtra, NULL); }
...
==============
*/
static void ToggleInactiveInternalCb(CMenuBaseItem* pSelf, void*) { pSelf->ToggleVisibility(); }
...
void UI_ShowMessageBox_f(void) { UI_ShowMessageBox(EngFuncs::CmdArgv(1)); }
