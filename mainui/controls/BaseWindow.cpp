...
bool CMenuBaseWindow::IsVisible() const { return m_pStack->IsVisible(this); }
...
bool CMenuBaseWindow::DrawAnimation()
{
	...
	if ((eTransitionType == ANIM_IN && alpha < 1.0f) || (eTransitionType == ANIM_OUT && alpha > 0.0f))
	{
