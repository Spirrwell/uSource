...
CMenuScrollView::CMenuScrollView() : CMenuItemsHolder(), m_bHoldingMouse1(false) {}
...
Point CMenuScrollView::GetPositionOffset() const { return Point(0, -m_iPos) + BaseClass::GetPositionOffset(); }

bool CMenuScrollView::MouseMove(int x, int y) { return CMenuItemsHolder::MouseMove(x, y); }
