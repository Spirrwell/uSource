...
public:
	...
	inline bool IsEmpty(void) const { return (Head() == InvalidIndex()); }
...
template <class T, class I> inline CUtlLinkedList<T, I>::CUtlLinkedList(int growSize, int initSize) : m_Memory(growSize, initSize)
{
	ConstructList();
	ResetDbgInfo();
}
...
inline CUtlLinkedList<T, I>::CUtlLinkedList(void* pMemory, int memsize) : m_Memory((ListElem_t*)pMemory, memsize / sizeof(ListElem_t))
{
	ConstructList();
	ResetDbgInfo();
}

template <class T, class I> inline CUtlLinkedList<T, I>::~CUtlLinkedList() { RemoveAll(); }

template <class T, class I> inline void CUtlLinkedList<T, I>::ConstructList()
{
	m_Head	       = InvalidIndex();
	m_Tail	       = InvalidIndex();
...
template <class T, class I> inline T& CUtlLinkedList<T, I>::Element(I i) { return m_Memory[i].m_Element; }

template <class T, class I> inline T const& CUtlLinkedList<T, I>::Element(I i) const { return m_Memory[i].m_Element; }

template <class T, class I> inline T& CUtlLinkedList<T, I>::operator[](I i) { return m_Memory[i].m_Element; }

template <class T, class I> inline T const& CUtlLinkedList<T, I>::operator[](I i) const { return m_Memory[i].m_Element; }

//-----------------------------------------------------------------------------
// list statistics
//-----------------------------------------------------------------------------

template <class T, class I> inline int CUtlLinkedList<T, I>::Count() const { return m_ElementCount; }

template <class T, class I> inline I CUtlLinkedList<T, I>::MaxElementIndex() const { return m_TotalElements; }

//-----------------------------------------------------------------------------
// Traversing the list
//-----------------------------------------------------------------------------

template <class T, class I> inline I CUtlLinkedList<T, I>::Head() const { return m_Head; }

template <class T, class I> inline I CUtlLinkedList<T, I>::First() const { return m_Head; }

template <class T, class I> inline I CUtlLinkedList<T, I>::Tail() const { return m_Tail; }

template <class T, class I> inline I CUtlLinkedList<T, I>::Previous(I i) const
{
	DbgAssert(IsValidIndex(i));
	return InternalElement(i).m_Previous;
}

template <class T, class I> inline I CUtlLinkedList<T, I>::Next(I i) const
{
...
template <class T, class I> inline bool CUtlLinkedList<T, I>::IsValidIndex(I i) const
{
	return (i < m_TotalElements) && (i >= 0) && ((m_Memory[i].m_Previous != i) || (m_Memory[i].m_Next == i));
}

template <class T, class I> inline bool CUtlLinkedList<T, I>::IsInList(I i) const { return (i < m_TotalElements) && (i >= 0) && (Previous(i) != i); }

//-----------------------------------------------------------------------------
// Makes sure we have enough memory allocated to store a requested # of elements
//-----------------------------------------------------------------------------

template <class T, class I> inline void CUtlLinkedList<T, I>::EnsureCapacity(int num)
{
...
template <class T, class I> inline void CUtlLinkedList<T, I>::Purge()
{
	RemoveAll();
	m_Memory.Purge();
	m_FirstFree	= InvalidIndex();
...
template <class T, class I> inline void CUtlLinkedList<T, I>::PurgeAndDeleteElements()
{
	int iNext;
...
//-----------------------------------------------------------------------------
template <class T, class I> inline I CUtlLinkedList<T, I>::AllocInternal(bool multilist)
{
	I elem;
...
template <class T, class I> inline I CUtlLinkedList<T, I>::Alloc(bool multilist)
{
...
template <class T, class I> inline void CUtlLinkedList<T, I>::Free(I elem)
{
...
template <class T, class I> inline I CUtlLinkedList<T, I>::InsertBefore(I before)
{
	// Make a new node
...
template <class T, class I> inline I CUtlLinkedList<T, I>::InsertAfter(I after)
{
	// Make a new node
	I newNode = AllocInternal();
...
template <class T, class I> inline I CUtlLinkedList<T, I>::AddToHead() { return InsertAfter(InvalidIndex()); }

template <class T, class I> inline I CUtlLinkedList<T, I>::AddToTail() { return InsertBefore(InvalidIndex()); }

//-----------------------------------------------------------------------------
// Swap one list for another
//-----------------------------------------------------------------------------

template <class T, class I> inline void CUtlLinkedList<T, I>::Swap(CUtlLinkedList<T, I>& list)
{
...
template <class T, class I> inline I CUtlLinkedList<T, I>::InsertBefore(I before, T const& src)
{
	// Make a new node
	I newNode = AllocInternal();
...
template <class T, class I> inline I CUtlLinkedList<T, I>::InsertAfter(I after, T const& src)
{
	// Make a new node
	I newNode = AllocInternal();
...
template <class T, class I> inline I CUtlLinkedList<T, I>::AddToHead(T const& src) { return InsertAfter(InvalidIndex(), src); }

template <class T, class I> inline I CUtlLinkedList<T, I>::AddToTail(T const& src) { return InsertBefore(InvalidIndex(), src); }

//-----------------------------------------------------------------------------
// Removal methods
//-----------------------------------------------------------------------------

template <class T, class I> inline I CUtlLinkedList<T, I>::Find(const T& src) const
{
...
template <class T, class I> inline bool CUtlLinkedList<T, I>::FindAndRemove(const T& src)
{
	I i = Find(src);
	if (i == InvalidIndex())
	{
...
template <class T, class I> inline T CUtlLinkedList<T, I>::RemoveFromHead()
{
...
template <class T, class I> inline T CUtlLinkedList<T, I>::RemoveFromTail()
{
...
template <class T, class I> inline void CUtlLinkedList<T, I>::Remove(I elem) { Free(elem); }

template <class T, class I> inline void CUtlLinkedList<T, I>::RemoveAll()
{
...
template <class T, class I> inline void CUtlLinkedList<T, I>::LinkBefore(I before, I elem)
{
	Assert(IsValidIndex(elem));
...
template <class T, class I> inline void CUtlLinkedList<T, I>::LinkAfter(I after, I elem)
{
	Assert(IsValidIndex(elem));
...
template <class T, class I> inline void CUtlLinkedList<T, I>::Unlink(I elem)
{
	Assert(IsValidIndex(elem));
	if (IsInList(elem))
	{
...
template <class T, class I> inline void CUtlLinkedList<T, I>::LinkToHead(I elem) { LinkAfter(InvalidIndex(), elem); }

template <class T, class I> inline void CUtlLinkedList<T, I>::LinkToTail(I elem) { LinkBefore(InvalidIndex(), elem); }

#ifdef DBGFLAG_VALIDATE
template <class T, class I> inline void CUtlLinkedList<T, I>::Validate(CValidator& validator, const char* pchName)
{
#ifdef _WIN32
...
template <class T, class I> inline void CUtlLinkedList<T, I>::ValidateSelfAndElements(CValidator& validator, const char* pchName)
{
#ifdef _WIN32
	validator.Push(typeid(*this).raw_name(), this, pchName);
#else
	...
	FOR_EACH_LL(*this, i) { functor(Element(i), pchName); }
