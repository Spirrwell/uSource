...
#define NUMSTR_CHECK_FAST(val, utype)                                                                                                                \
	...
	// SDR_PUBLIC inline const char* SetHexUint64( uint64 un64 )	{ V_binarytohex( (byte *)&un64, sizeof( un64 ), m_szBuf, sizeof( m_szBuf ) );
	// m_nLength = V_strlen(m_szBuf); return m_szBuf; }
