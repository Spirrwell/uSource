...
#include "utlvector.h"
template <typename T> class CDefUtlPriorityQueueSetIndexFunc
{
public:
...
template <class T, class L = bool (*)(T const&, T const&), class SetIndexFunc = CDefUtlPriorityQueueSetIndexFunc<T>> class CUtlPriorityQueue
{
public:
	// Less func typedef
...
template <class T, class LessFunc, class SetIndexFunc> inline void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::RemoveAtHead()
{
...
template <class T, class LessFunc, class SetIndexFunc> inline void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::RemoveAt(int index)
{
...
template <class T, class LessFunc, class SetIndexFunc> inline void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::RevaluateElement(int nStartingIndex)
{
...
template <class T, class LessFunc, class SetIndexFunc> inline int CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::PercolateDown(int index)
{
	int count = Count();
...
template <class T, class LessFunc, class SetIndexFunc> inline int CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::PercolateUp(int index)
{
	if (index >= Count())
		return index;
...
template <class T, class LessFunc, class SetIndexFunc> inline void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::Insert(T const& element)
{
...
template <class T, class LessFunc, class SetIndexFunc> void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::Swap(int index1, int index2)
{
	T tmp	       = m_heap[index1];
...
template <class T, class LessFunc, class SetIndexFunc> void CUtlPriorityQueue<T, LessFunc, SetIndexFunc>::SetLessFunc(LessFunc_t lessfunc)
{
	m_LessFunc = lessfunc;
}
