...
template <typename T> class CDefOps
{
public:
...
template <typename T> class CDefLessReverse
{
public:
	CDefLessReverse() {}
...
template <typename T> class CDefLessPtr
{
public:
...
template <typename RBTREE_T> void SetDefLessFunc(RBTREE_T& RBTree)
{
#ifdef _MSC_VER
...
template <class I> class CDefRBTreeBalanceListener
{
public:
...
template <class T, class I> class CRBTreeBalanceListener
{
public:
...
{
template <class I> struct Links_t
{
	I m_Left;
	I m_Right;
	I m_Parent;
...
template <class I, class E> class CUtlRBTreeBase
{
public:
	CUtlRBTreeBase();
...
protected:
	...
	inline void ResetDbgInfo(void* pMemBase) { m_data.m_pElements = pMemBase; }
...
public:
	...
	static bool BDiffRBTrees(const CUtlRBTree<T, I, L, E>& rbTreeBase, const CUtlRBTree<T, I, L, E>& rbTreeCompare,
				 CUtlRBTree<T, I, L, E>* prbTreeAdditions = NULL, CUtlRBTree<T, I, L, E>* prbTreeDeletions = NULL);
...
template <class I, class E> CUtlRBTreeBase<I, E>::CUtlRBTreeBase()
{
...
inline CUtlRBTree<T, I, L, E>::CUtlRBTree(int growSize, int initSize, const LessFunc_t& lessfunc)
	: CUtlRBTreeBase<I, E>(), m_LessFunc(lessfunc), m_Elements(growSize, initSize)
{
	this->ResetDbgInfo(m_Elements.Base());
}

template <class T, class I, typename L, class E>
inline CUtlRBTree<T, I, L, E>::CUtlRBTree(const LessFunc_t& lessfunc) : CUtlRBTreeBase<I, E>(), m_Elements(0, 0), m_LessFunc(lessfunc)
{
	this->ResetDbgInfo(m_Elements.Base());
}

template <class T, class I, typename L, class E>
inline CUtlRBTree<T, I, L, E>::CUtlRBTree(const BalanceListener_t& eventListener) : CUtlRBTreeBase<I, E>(), m_Elements(0, 0), m_LessFunc(NULL)
{
	CUtlRBTreeBase<I, E>::m_data = eventListener;
	this->ResetDbgInfo(m_Elements.Base());
}

template <class T, class I, typename L, class E> inline CUtlRBTree<T, I, L, E>::~CUtlRBTree() { RemoveAll(); }

//-----------------------------------------------------------------------------
// gets particular elements
//-----------------------------------------------------------------------------

template <class T, class I, typename L, class E> inline T& CUtlRBTree<T, I, L, E>::Element(I i) { return m_Elements[i].m_Data; }

template <class T, class I, typename L, class E> inline T const& CUtlRBTree<T, I, L, E>::Element(I i) const { return m_Elements[i].m_Data; }

template <class T, class I, typename L, class E> inline T& CUtlRBTree<T, I, L, E>::operator[](I i) { return Element(i); }

template <class T, class I, typename L, class E> inline T const& CUtlRBTree<T, I, L, E>::operator[](I i) const { return Element(i); }

template <class T, class I, typename L, class E> inline T& CUtlRBTree<T, I, L, E>::ElementByLinearIndex(IndexType_t i)
{
...
template <class T, class I, typename L, class E> inline const T& CUtlRBTree<T, I, L, E>::ElementByLinearIndex(IndexType_t i) const
{
	IndexType_t cElementsSeen = 0;
	IndexType_t iterator	  = 0;
	for (; iterator < CUtlRBTree<T, I, L, E>::MaxElement(); ++iterator)
...
template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsValidLinearIndex(IndexType_t i) const
{
	return i >= 0 && i < (IndexType_t)CUtlRBTree<T, I, L, E>::Count();
}

template <class T, class I, typename L, class E> inline CUtlRBTree<T, I, L, E>& CUtlRBTree<T, I, L, E>::operator=(const CUtlRBTree<T, I, L, E>& other)
{
	RemoveAll();
...
template <class I, class E> inline I CUtlRBTreeBase<I, E>::Root() const { return m_Root; }

//-----------------------------------------------------------------------------
// Num elements
//-----------------------------------------------------------------------------

template <class I, class E> inline unsigned int CUtlRBTreeBase<I, E>::Count() const { return (unsigned int)m_NumElements; }

//-----------------------------------------------------------------------------
// Num elements allocated
//-----------------------------------------------------------------------------

template <class T, class I, typename L, class E> inline unsigned int CUtlRBTree<T, I, L, E>::NumAllocated() const
{
...
template <class I, class E> inline I CUtlRBTreeBase<I, E>::MaxElement() const { return (I)m_TotalElements; }

//-----------------------------------------------------------------------------
// Gets the children
//-----------------------------------------------------------------------------

template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::Parent(I i) const
{
	return CUtlRBTreeBase<I, E>::_Parent(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline I CUtlRBTreeBase<I, E>::_Parent(I i, size_t unNodeSize, void* pMemBase) const
{
	return _Links(i, unNodeSize, pMemBase).m_Parent;
}

template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::LeftChild(I i) const
{
	return CUtlRBTreeBase<I, E>::_LeftChild(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline I CUtlRBTreeBase<I, E>::_LeftChild(I i, size_t unNodeSize, void* pMemBase) const
{
	return _Links(i, unNodeSize, pMemBase).m_Left;
}

template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::RightChild(I i) const
{
	return CUtlRBTreeBase<I, E>::_RightChild(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline I CUtlRBTreeBase<I, E>::_RightChild(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsLeftChild(I i) const
{
	return _IsLeftChild(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline bool CUtlRBTreeBase<I, E>::_IsLeftChild(I i, size_t unNodeSize, void* pMemBase) const
{
	return _LeftChild(_Parent(i, unNodeSize, pMemBase), unNodeSize, pMemBase) == i;
}

template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsRightChild(I i) const
{
	return _IsRightChild(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline bool CUtlRBTreeBase<I, E>::_IsRightChild(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class I, class E> inline bool CUtlRBTreeBase<I, E>::IsRoot(I i) const { return i == m_Root; }

template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsLeaf(I i) const
{
...
template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsValidIndex(I i) const
{
	return this->_IsValidIndex(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> inline bool CUtlRBTreeBase<I, E>::_IsValidIndex(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class T, class I, typename L, class E> inline int CUtlRBTree<T, I, L, E>::Depth() const { return Depth(CUtlRBTreeBase<I, E>::Root()); }

//-----------------------------------------------------------------------------
// Sets the children
//-----------------------------------------------------------------------------

template <class I, class E> inline void CUtlRBTreeBase<I, E>::_SetParent(I i, I parent, size_t unSizeOfNode, void* pMemBase)
{
	_Links(i, unSizeOfNode, pMemBase).m_Parent = parent;
}

template <class I, class E> inline void CUtlRBTreeBase<I, E>::_SetLeftChild(I i, I child, size_t unSizeOfNode, void* pMemBase)
{
	_Links(i, unSizeOfNode, pMemBase).m_Left = child;
}

template <class I, class E> inline void CUtlRBTreeBase<I, E>::_SetRightChild(I i, I child, size_t unSizeOfNode, void* pMemBase)
{
...
template <class I, class E> inline typename CUtlRBTreeInternal::Links_t<I>& CUtlRBTreeBase<I, E>::_Links(I i, size_t unNodeSize, void* pMemBase)
{
...
template <class I, class E> inline bool CUtlRBTreeBase<I, E>::_IsRed(I i, size_t unNodeSize, void* pMemBase) const
{
	return (_Links(i, unNodeSize, pMemBase).m_Tag == CUtlRBTreeInternal::RED);
}

template <class I, class E> inline bool CUtlRBTreeBase<I, E>::_IsBlack(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class I, class E> inline CUtlRBTreeInternal::NodeColor_t CUtlRBTreeBase<I, E>::_Color(I i, size_t unNodeSize, void* pMemBase) const
{
	return (CUtlRBTreeInternal::NodeColor_t)_Links(i, unNodeSize, pMemBase).m_Tag;
}

template <class I, class E> inline void CUtlRBTreeBase<I, E>::_SetColor(I i, CUtlRBTreeInternal::NodeColor_t c, size_t unNodeSize, void* pMemBase)
{
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::NewNode(bool bConstructElement)
{
	I newElem;
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::FreeNode(I i)
{
...
template <class I, class E> void CUtlRBTreeBase<I, E>::_RotateLeft(I elem, size_t unNodeSize, void* pMemBase)
{
...
template <class I, class E> void CUtlRBTreeBase<I, E>::_RotateRight(I elem, size_t unNodeSize, void* pMemBase)
{
...
template <class I, class E> inline void CUtlRBTreeBase<I, E>::_InsertRebalance(I elem, size_t unNodeSize, void* pMemBase)
{
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::InsertAt(I parent, bool leftchild, bool bConstructElement)
{
...
template <class I, class E> void CUtlRBTreeBase<I, E>::_LinkToParent(I i, I parent, bool isLeft, size_t unNodeSize, void* pMemBase)
{
...
template <class I, class E> void CUtlRBTreeBase<I, E>::_RemoveRebalance(I elem, size_t unNodeSize, void* pMemBase)
{
...
template <class I, class E> void CUtlRBTreeBase<I, E>::_Unlink(I elem, size_t unNodeSize, void* pMemBase)
{
	...
	if (_IsValidIndex(elem, unNodeSize, pMemBase))
	{
		...
		if ((_LeftChild(elem, unNodeSize, pMemBase) == INVALID_RBTREE_IDX) || (_RightChild(elem, unNodeSize, pMemBase) == INVALID_RBTREE_IDX))
		{
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Link(I elem)
{
	if (elem != INVALID_RBTREE_IDX)
	{
		I    parent;
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::RemoveAt(I elem)
{
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::RemoveAll()
{
...
// purge
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Purge()
{
	RemoveAll();
...
// iteration
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::FirstInorder() const
{
	return CUtlRBTreeBase<I, E>::_FirstInorder(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_FirstInorder(size_t unNodeSize, void* pMemBase) const
{
	I i = m_Root;
...
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::NextInorder(I i) const
{
	return CUtlRBTreeBase<I, E>::_NextInorder(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_NextInorder(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::PrevInorder(I i) const
{
	return CUtlRBTreeBase<I, E>::_PrevInorder(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_PrevInorder(I i, size_t unNodeSize, void* pMemBase) const
{
	DbgAssert(_IsValidIndex(i, unNodeSize, pMemBase));
...
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::LastInorder() const
{
	return CUtlRBTreeBase<I, E>::_LastInorder(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_LastInorder(size_t unNodeSize, void* pMemBase) const
{
	I i = m_Root;
	while (_RightChild(i, unNodeSize, pMemBase) != INVALID_RBTREE_IDX)
		i = _RightChild(i, unNodeSize, pMemBase);
...
template <class I, class E> I CUtlRBTreeBase<I, E>::FirstPreorder() const { return m_Root; }

template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::NextPreorder(I i) const
{
	return CUtlRBTreeBase<I, E>::_NextPreorder(i, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_NextPreorder(I i, size_t unNodeSize, void* pMemBase) const
{
	if (_LeftChild(i, unNodeSize, pMemBase) != INVALID_RBTREE_IDX)
...
template <class I, class E> I CUtlRBTreeBase<I, E>::PrevPreorder(I i) const
{
	Assert(0); // not implemented yet
	return INVALID_RBTREE_IDX;
}

template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::LastPreorder() const
{
	return CUtlRBTreeBase<I, E>::_LastPreorder(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_LastPreorder(size_t unNodeSize, void* pMemBase) const
{
	I i = m_Root;
	for (;;)
	{
...
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::FirstPostorder() const
{
	return CUtlRBTreeBase<I, E>::_FirstPostorder(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_FirstPostorder(size_t unNodeSize, void* pMemBase) const
{
	I i = m_Root;
...
template <class T, class I, typename L, class E> inline I CUtlRBTree<T, I, L, E>::NextPostorder(I i) const
{
	return CUtlRBTreeBase<I, E>::_NextPostorder(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> I CUtlRBTreeBase<I, E>::_NextPostorder(I i, size_t unNodeSize, void* pMemBase) const
{
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Reinsert(I elem)
{
	Unlink(elem);
	Link(elem);
}
...
template <class T, class I, typename L, class E> inline int CUtlRBTree<T, I, L, E>::Depth(I node) const
{
	return CUtlRBTreeBase<I, E>::_Depth(node, sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> int CUtlRBTreeBase<I, E>::_Depth(I node, size_t unNodeSize, void* pMemBase) const
{
	if (node == INVALID_RBTREE_IDX)
		return 0;
...
template <class T, class I, typename L, class E> inline bool CUtlRBTree<T, I, L, E>::IsValid() const
{
	return CUtlRBTreeBase<I, E>::_IsValid(sizeof(Node_t), (void*)m_Elements.Base());
}

template <class I, class E> bool CUtlRBTreeBase<I, E>::_IsValid(size_t unNodeSize, void* pMemBase) const
{
	if (!Count())
		return true;
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::SetLessFunc(const typename CUtlRBTree<T, I, L, E>::LessFunc_t& func)
{
	if (!m_LessFunc)
		m_LessFunc = func;
	else
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::Insert(T const& insert, bool bInsertDuplicates)
{
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::InsertIfNotFound(T const& insert)
{
	// use copy constructor to copy it in
	I    parent;
	bool leftchild;
...
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Insert(const T* pArray, int nItems, bool bInsertDuplicates)
{
	while (nItems--)
	{
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::FindOrInsert(T const& insert)
{
	// use copy constructor to copy it in
	I    parent;
	bool leftchild;
...
template <class T, class I, typename L, class E> bool CUtlRBTree<T, I, L, E>::HasElement(T const& search) const
{
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::Find(T const& search) const
{
	Assert(m_LessFunc);
...
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::FindFirst(T const& search) const
{
	Assert(m_LessFunc);
...
// swap in place
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Swap(CUtlRBTree<T, I, L, E>& that)
{
...
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E> I CUtlRBTree<T, I, L, E>::FindClosest(T const& search, CompareOperands_t eFindCriteria) const
{
	Assert(m_LessFunc);
...
// Makes sure we have enough memory allocated to store a requested # of elements
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::EnsureCapacity(int num)
{
...
//-----------------------------------------------------------------------------
template <class T, class I, typename L, class E>
bool CUtlRBTree<T, I, L, E>::BDiffRBTrees(const CUtlRBTree<T, I, L, E>& rbTreeBase, const CUtlRBTree<T, I, L, E>& rbTreeCompare,
...
//-----------------------------------------------------------------------------
#ifdef DBGFLAG_VALIDATE
template <class T, class I, typename L, class E> void CUtlRBTree<T, I, L, E>::Validate(CValidator& validator, const char* pchName)
{
#ifdef _WIN32
