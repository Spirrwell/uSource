...
//-----------------------------------------------------------------------------
#define SetUtlBufferOverflowFuncs(_get, _put) SetOverflowFuncs(static_cast<UtlBufferOverflowFunc_t>(_get), static_cast<UtlBufferOverflowFunc_t>(_put))
...
// What am I reading?
//-----------------------------------------------------------------------------
inline const void* CUtlBuffer::PeekGet(int offset) const { return &m_Memory[m_Get + offset]; }

//-----------------------------------------------------------------------------
// no offset so optimizer can resolve the function
//-----------------------------------------------------------------------------
inline const void* CUtlBuffer::PeekGet() const { return &m_Memory[m_Get]; }

//-----------------------------------------------------------------------------
// Reserve nBytes at the put location and return pointer; follow with SeekPut
//-----------------------------------------------------------------------------
inline void* CUtlBuffer::ReservePut(int nBytes) { return CheckPut(nBytes) ? PeekPut() : NULL; }
...
// What am I reading?
//-----------------------------------------------------------------------------
inline void* CUtlBuffer::PeekPut(int offset) { return &m_Memory[m_Put + offset]; }
...
inline void CUtlBuffer::CopyToString(CUtlString& strText) const { strText.SetDirect((const char*)Base(), TellMaxPut()); }

inline int CUtlBuffer::Size() const // FIXME delete soon
{
	return m_Memory.NumAllocated();
}
inline int CUtlBuffer::SizeAllocated() const { return m_Memory.NumAllocated(); }
...
inline void CUtlBuffer::CopyBuffer(const CUtlBuffer& buffer) { CopyBuffer(buffer.Base(), buffer.TellPut()); }
