...
void CUtlBuffer::PutUint8(uint8 ub) { PUT_TYPE(uint8, ub); }

void CUtlBuffer::PutUnsignedInt64(uint64 ub) { PUT_TYPE(uint64, ub); }

void CUtlBuffer::PutInt64(int64 ub) { PUT_TYPE(int64, ub); }

void CUtlBuffer::PutInt16(int16 s16) { PUT_TYPE(int16, s16); }

void CUtlBuffer::PutShort(short s) { PUT_TYPE(short, s); }

void CUtlBuffer::PutUnsignedShort(unsigned short s) { PUT_TYPE(unsigned short, s); }

void CUtlBuffer::PutInt(int i) { PUT_TYPE(int, i); }

void CUtlBuffer::PutUnsignedInt(unsigned int u) { PUT_TYPE(unsigned int, u); }
