...
inline bool _internal_isspace(char c) { return (c == ' ' || c == '\t' || c == '\n' || c == '\r'); }
...
void KeyValues::DumpToStream(FILE* fs) { this->DumpToStreamInternal(fs, 0); }
...
void KeyValues::SetErrorCallback(KeyValues::pfnErrorCallback_t callback) { this->pCallback = callback; }
