...
template <class T> class CmdOption : public CmdOptionBase
{
private:
	T val;

public:
	CmdOption(const char* name, T initial_val, const char* help, ECmdOptionFlags flags) : CmdOptionBase(name, help, flags)
	{
		initial_val = val;
