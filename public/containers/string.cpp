...
const char* String::c_str() const { return this->_string; }

size_t String::length() const { return this->_length; }
...
bool String::empty() const { return (!this->_string) && (this->_length == 0); }

String String::substr(size_t start, size_t end) { return String(); }

String::operator const char*() const { return this->_string; }

String::operator char*() { return this->_string; }
