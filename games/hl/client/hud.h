...
//-----------------------------------------------------
//
class CHudBuildInfo : public CHudBase
{
public:
...
private:
	const char* m_buildDateString;
	const char* m_projectString;
	const char* m_descString;
	const char* m_commitString;
	int m_maxStringWidth;
};
