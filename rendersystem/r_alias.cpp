...
void GL_MakeAliasModelDisplayLists(model_t* m)
{
	...
	m_pAliasHeader->posedata =
		static_cast<trivertex_t*>(Mem_Malloc(m->mempool, m_pAliasHeader->numposes * m_pAliasHeader->poseverts * sizeof(trivertex_t)));
...
void* Mod_LoadSingleSkin(daliasskintype_t* pskintype, int skinnum, int size)
{
	...
	m_pAliasHeader->gl_texturenum[skinnum][0] = m_pAliasHeader->gl_texturenum[skinnum][1] = m_pAliasHeader->gl_texturenum[skinnum][2] =
	...
	if (R_GetTexture(m_pAliasHeader->gl_texturenum[skinnum][0])->flags & TF_HAS_LUMA)
	{
		...
		m_pAliasHeader->fb_texturenum[skinnum][0] = m_pAliasHeader->fb_texturenum[skinnum][1] = m_pAliasHeader->fb_texturenum[skinnum][2] =
