...
=================
*/
qboolean R_CullBox(const vec3_t mins, const vec3_t maxs) { return GL_FrustumCullBox(&RI.frustum, mins, maxs, 0); }
...
=================
*/
qboolean R_CullSphere(const vec3_t centre, const float radius) { return GL_FrustumCullSphere(&RI.frustum, centre, radius, 0); }
