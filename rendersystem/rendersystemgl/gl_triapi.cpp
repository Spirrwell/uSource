...
void CTriangleAPI_GL::End(void) { pglEnd(); }

void CTriangleAPI_GL::TexCoord2f(float u, float v) { pglTexCoord2f(u, v); }

void CTriangleAPI_GL::Vertex3fv(const float* v) { pglVertex3fv(v); }

void CTriangleAPI_GL::Vertex3f(float x, float y, float z) { pglVertex3f(x, y, z); }
...
void CTriangleAPI_GL::GetMatrix(const int pname, float* matrix) { pglGetFloatv(pname, matrix); }
...
ITriangleAPI* CRenderSystem_GL::GetTriAPI() { return &g_TriAPI; }