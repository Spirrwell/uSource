...
int __MsgFunc_Logo(const char* pszName, int iSize, void* pbuf) { return gHUD.MsgFunc_Logo(pszName, iSize, pbuf); }

// DECLARE_MESSAGE( m_Logo, Logo )
int __MsgFunc_ResetHUD(const char* pszName, int iSize, void* pbuf) { return gHUD.MsgFunc_ResetHUD(pszName, iSize, pbuf); }
...
int __MsgFunc_SetFOV(const char* pszName, int iSize, void* pbuf) { return gHUD.MsgFunc_SetFOV(pszName, iSize, pbuf); }

int __MsgFunc_Concuss(const char* pszName, int iSize, void* pbuf) { return gHUD.MsgFunc_Concuss(pszName, iSize, pbuf); }

int __MsgFunc_GameMode(const char* pszName, int iSize, void* pbuf) { return gHUD.MsgFunc_GameMode(pszName, iSize, pbuf); }
...
int __MsgFunc_ValClass(const char* pszName, int iSize, void* pbuf) { return 0; }
...
int __MsgFunc_VGUIMenu(const char* pszName, int iSize, void* pbuf) { return 0; }

int __MsgFunc_BuildSt(const char* pszName, int iSize, void* pbuf) { return 0; }

int __MsgFunc_RandomPC(const char* pszName, int iSize, void* pbuf) { return 0; }
...
float CHud::GetSensitivity(void) { return m_flMouseSensitivity; }
