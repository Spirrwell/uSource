...
#define DECLARE_MESSAGE(y, x)                                                                                                                        \
	int __MsgFunc_##x(const char* pszName, int iSize, void* pbuf) { return gHUD.y.MsgFunc_##x(pszName, iSize, pbuf); }

#define HOOK_COMMAND(x, y) gEngfuncs.pfnAddCommand(x, __CmdFunc_##y);
#define DECLARE_COMMAND(y, x)                                                                                                                        \
	void __CmdFunc_##x(void) { gHUD.y.UserCmd_##x(); }
#undef CVAR_GET_FLOAT
#undef CVAR_GET_STRING

inline float	      CVAR_GET_FLOAT(const char* x) { return gEngfuncs.pfnGetCvarFloat((char*)x); }
inline char*	      CVAR_GET_STRING(const char* x) { return const_cast<char*>(gEngfuncs.pfnGetCvarString((char*)x)); }
...
inline int TextMessageDrawChar(int x, int y, int number, int r, int g, int b) { return gEngfuncs.pfnDrawCharacter(x, y, number, r, g, b); }
