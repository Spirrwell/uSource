...
void CHudServers::SortServers(const char* fieldname)
{
	...
	qsort(pSortArray, (size_t)nCount, (size_t)nSize, FnServerCompare);
...
int CHudServers::isQuerying() { return m_nRequesting ? 1 : 0; }
...
===================
*/
int CHudServers::GetServerCount(void) { return m_nServerCount; }
