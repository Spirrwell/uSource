...
public:
	...
	virtual BOOL GetNextBestWeapon(CBasePlayer*	pPlayer,
	...
	virtual void
			 PlayerThink(CBasePlayer* pPlayer) = 0; // called by CBasePlayer::PreThink every frame, before physics are run and after keys are accepted
	...
	virtual void PlayerGotWeapon(CBasePlayer*     pPlayer,
