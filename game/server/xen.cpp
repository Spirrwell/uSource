...
void CXenPLight::Spawn(void)
{
	...
	m_pGlow->SetTransparency(kRenderGlow, (int)pev->rendercolor.x, (int)pev->rendercolor.y, (int)pev->rendercolor.z, (int)pev->renderamt,
				 (int)pev->renderfx);
...
void CXenHair::Precache(void) { PRECACHE_MODEL("models/hair.mdl"); }
...
const Vector CXenSporeLarge::m_hullSizes[] = {
	Vector(90, -25, 0), Vector(25, 75, 0), Vector(-15, -100, 0), Vector(-90, -35, 0), Vector(-90, 60, 0),
};
...
void CXenSpore::Precache(void) { PRECACHE_MODEL(pModelNames[pev->skin]); }
