...
TYPEDESCRIPTION CBarney::m_SaveData[] = {
	DEFINE_FIELD(CBarney, m_fGunDrawn, FIELD_BOOLEAN),    DEFINE_FIELD(CBarney, m_painTime, FIELD_TIME),
	DEFINE_FIELD(CBarney, m_checkAttackTime, FIELD_TIME), DEFINE_FIELD(CBarney, m_lastAttackCheck, FIELD_BOOLEAN),
...
Schedule_t slBaFollow[] = {
	{tlBaFollow, ARRAYSIZE(tlBaFollow),
	 bits_COND_NEW_ENEMY | bits_COND_LIGHT_DAMAGE | bits_COND_HEAVY_DAMAGE | bits_COND_HEAR_SOUND | bits_COND_PROVOKED, bits_SOUND_DANGER,
	 "Follow"},
};
...
Schedule_t slBaFaceTarget[] = {
	{tlBaFaceTarget, ARRAYSIZE(tlBaFaceTarget),
...
Schedule_t slIdleBaStand[] = {
	{tlIdleBaStand, ARRAYSIZE(tlIdleBaStand),
...
void CBarney::StartTask(Task_t* pTask) { CTalkMonster::StartTask(pTask); }
...
{
	return bits_SOUND_WORLD | bits_SOUND_COMBAT | bits_SOUND_CARCASS | bits_SOUND_MEAT | bits_SOUND_GARBAGE | bits_SOUND_DANGER |
	       bits_SOUND_PLAYER;
}
...
// relationship table.
//=========================================================
int CBarney::Classify(void) { return CLASS_PLAYER_ALLY; }
...
MONSTERSTATE CBarney::GetIdealState(void) { return CTalkMonster::GetIdealState(); }
