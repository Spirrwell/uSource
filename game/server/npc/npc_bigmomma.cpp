...
public:
	...
	void OverrideReset(void) { m_crabCount = 0; }
...
TYPEDESCRIPTION CBigMomma::m_SaveData[] = {
	DEFINE_FIELD(CBigMomma, m_nodeTime, FIELD_TIME),     DEFINE_FIELD(CBigMomma, m_crabTime, FIELD_TIME),
	DEFINE_FIELD(CBigMomma, m_mortarTime, FIELD_TIME),   DEFINE_FIELD(CBigMomma, m_painSoundTime, FIELD_TIME),
...
// relationship table.
//=========================================================
int CBigMomma::Classify(void) { return CLASS_ALIEN_MONSTER; }
...
// Lay a crab
BOOL CBigMomma::CheckMeleeAttack2(float flDot, float flDist) { return CanLayCrab(); }
