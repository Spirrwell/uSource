...
// ********** Scientist DIE **********
//
void CLegacyCineMonster ::Die(void) { SetThink(&CBaseEntity::SUB_Remove); }

//
// ********** Scientist PAIN **********
//
void CLegacyCineMonster ::Pain(void) { EMIT_SOUND(ENT(pev), CHAN_VOICE, "player/pain3.wav", 1, ATTN_NORM); }
