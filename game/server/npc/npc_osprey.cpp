...
void COsprey::CommandUse(CBaseEntity* pActivator, CBaseEntity* pCaller, USE_TYPE useType, float value) { pev->nextthink = gpGlobals->time + 0.1; }
...
void COsprey::HitTouch(CBaseEntity* pOther) { pev->nextthink = gpGlobals->time + 2.0; }
