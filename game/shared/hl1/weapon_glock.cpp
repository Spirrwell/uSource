...
void CGlock::SecondaryAttack(void) { GlockFire(0.1, 0.2, FALSE); }

void CGlock::PrimaryAttack(void) { GlockFire(0.01, 0.3, TRUE); }
...
void CGlock::GlockFire(float flSpread, float flCycleTime, BOOL fUseAutoAim)
{
	...
	Vector vecDir;
	vecDir = m_pPlayer->FireBulletsPlayer(1, vecSrc, vecAiming, Vector(flSpread, flSpread, flSpread), 8192, BULLET_PLAYER_9MM, 0, 0,
					      m_pPlayer->pev, m_pPlayer->random_seed);

	PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), fUseAutoAim ? m_usFireGlock1 : m_usFireGlock2, 0.0, (float*)&g_vecZero, (float*)&g_vecZero,
