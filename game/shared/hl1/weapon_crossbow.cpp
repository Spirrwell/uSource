...
int CCrossbowBolt::Classify(void) { return CLASS_NONE; }
...
void CCrossbow::Reload(void)
{
	...
	{
		EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_ITEM, "weapons/xbow_reload1.wav", RANDOM_FLOAT(0.95, 1.0), ATTN_NORM, 0,
