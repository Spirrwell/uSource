...
CBaseEntity* CBasePlayerItem::Respawn(void)
{
	...
	if (pNewWeapon)
	{
		...
		// not a typo! We want to know when the weapon the player just picked up should respawn! This new entity we created is the
		// replacement, but when it should respawn is based on conditions belonging to the weapon that was taken.
