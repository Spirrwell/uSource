...
const KeyValues& CWeaponScript::GetSounds() const { return *m_sounds; }

const KeyValues& CWeaponScript::GetProperties() const { return *m_props; }
...
bool CWeaponScript::Good() const { return this->m_kv && this->m_kv->IsGood(); }