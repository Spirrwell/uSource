...
TYPEDESCRIPTION CBasePlayerItem::m_SaveData[] = {
	DEFINE_FIELD(CBasePlayerItem, m_pPlayer, FIELD_CLASSPTR), DEFINE_FIELD(CBasePlayerItem, m_pNext, FIELD_CLASSPTR),
...
void CBasePlayerWeapon::ResetEmptySound(void) { m_iPlayEmptySound = 1; }
