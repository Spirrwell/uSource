...
public:
	...
	void
		     DispatchAnimEvents(float flFutureInterval = 0.1); // Handle events that have happend since last time called up until X seconds into the future
...
{
public:
	CBaseToggle() : m_bAngMoveDone(false), m_bLinearMoveDone(false) {}
