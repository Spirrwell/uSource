...
GLvoid GL_MANGLE(glTexParameterf)(GLenum target, GLenum pname, GLfloat param)
{
	if (pname == GL_TEXTURE_BORDER_COLOR)
	{
		return; // not supported by opengl es
...
GLvoid GL_MANGLE(glTexParameterfv)(GLenum target, GLenum pname, const GLfloat* params) { GL_MANGLE(glTexParameterf)(target, pname, params[0]); }

GLvoid wes_convert_BGR2RGB(const GLubyte* inb, GLubyte* outb, GLint size)
{
	int i;
	for (i = 0; i < size; i += 3)
	{
...
GLvoid wes_convert_BGRA2RGBA(const GLubyte* inb, GLubyte* outb, GLint size)
{
	int i;
	for (i = 0; i < size; i += 4)
	{
...
GLvoid wes_clear_alpha(const GLubyte* inb, GLubyte* outb, GLint size)
{
	int i;
	for (i = 0; i < size; i += 4)
	{
...
GLvoid wes_convert_RGBA2RGB(const GLubyte* inb, GLubyte* outb, GLint insize, GLint outsize)
{
	int i, j;
...
GLvoid wes_convert_I2LA(const GLubyte* inb, GLubyte* outb, GLint size)
{
	int i;
	for (i = 0; i < size; i += 1)
	{
...
GLvoid GL_MANGLE(glTexImage2D)(GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format,
			       GLenum type, const GLvoid* pixels)
{
	...
	if (pixels && format == GL_RGBA &&
	    (internalFormat == GL_RGB || internalFormat == GL_RGB8 || internalFormat == GL_RGB5 || internalFormat == GL_LUMINANCE ||
	     internalFormat == GL_LUMINANCE8 || internalFormat == GL_LUMINANCE4)) // strip alpha from texture
	{
...
GLvoid GL_MANGLE(glTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type,
				  const GLvoid* pixels)
{
...
GLvoid GL_MANGLE(glTexImage1D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type,
			       const GLvoid* pixels)
{
	GL_MANGLE(glTexImage2D)(GL_TEXTURE_2D, level, internalformat, width, 1, border, format, type, pixels);
}

GLvoid GL_MANGLE(glTexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border,
...
GLvoid GL_MANGLE(glTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
				  GLsizei depth, GLenum format, GLenum type, const GLvoid* pixels)
{
	wes_gl->glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels);
}

GLvoid wes_halveimage(GLint nw, GLint nh, GLint byteperpixel, char* data, char* newdata)
{
	int i, j;
	for (i = 0; i < nw; i++)
	{
...
GLvoid gluBuild2DMipmaps(GLenum target, GLint components, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* pixels)
{
	int    i	    = 1;
