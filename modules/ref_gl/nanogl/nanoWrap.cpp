...
{
	GL_MANGLE( glTexImage2D )
	( GL_TEXTURE_2D, level, internalformat, width, 1, border, format, type, pixels );
}
...
{
	GL_MANGLE( glTexImage2D )
	( GL_TEXTURE_2D, level, internalformat, width, height, border, format, type, pixels );
}
...
{
	GL_MANGLE( glTexSubImage2D )
	( target, level, xoffset, 0, width, 1, format, type, pixels );
}
...
{
	GL_MANGLE( glMultiTexCoord2fARB )
	( a, b, c );
}
